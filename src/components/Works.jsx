...
const Works = () => {
  return (
    <>
    <motion.div>
      <p className={style.sectionSubText}>My Project</p>
      <h2 className={style.sectionHeadText}>Projects.</h2>
    </motion.div>

    <div className='w-full flex flex-col'>
      <motion.p variants={fadeIn("", "",0.1 ,1)} className='mt-3 text-secondary nax-w-3xl text-[17px] leading-[30px]'>
      ...
      <div className='mt-12 flex flex-wrap gap-7 w-full justify-center items-center'>
